...
namespace BaseStats
{
    ...
    public class ObjectState
    {
        ...
        protected Dictionary<ObjectProperty, IntProperty> Dic_IntProperty = new Dictionary<ObjectProperty, IntProperty>();
        ...
        public void Set_Property(IntProperty intProperty)
        {
        ...
        public void Set_Property(FloatProperty floatProperty)
        {
        ...
        public void Set_Property(StringProperty stringProperty)
        {
